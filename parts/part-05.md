# Part 05 — The Stage Lexicon (Technical ⇄ Theatrical)
...
**Examples:**
- `Scene` ↔ stage zone; `WindowGroup` ↔ main stage; `Settings` ↔ backstage.
- `VStack/HStack/ZStack` ↔ vertical/horizontal/depth blocking.
